                ...
                <div key={complaint.id} className="card mb-3">
                    <div className="card-body">
                        ...
                        <textarea
                            ...
                            onChange={e => setFeedback({...feedback, [complaint.id]: e.target.value})}
                        />
                        <button style={{"marginRight":20} } className="btn btn-primary mt-2" onClick={() => handleFeedbackSubmit(complaint.id)}>Submit Feedback</button>
                        <button className="btn btn-secondary mt-2 ml-2" onClick={() => handleReraiseComplaint(complaint.id)}>Reraise Complaint</button>
